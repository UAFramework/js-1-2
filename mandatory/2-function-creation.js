...
function applyDiscount(totalPrice) {
  let discountFrom200AndMore = (100-10)/100;
  let discountFromLessThan200 = (100-5)/100;
  if (totalPrice >= 200) {
    return totalPrice *  discountFrom200AndMore;
  } else {
    return totalPrice * discountFromLessThan200;
  };
}
